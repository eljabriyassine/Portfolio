...
export default function Contact() {
  ...
  return (
    ...
    >
      <ToastContainer />
      <motion.div
        e="flex-1 flex  flex-col gap-1 justify-center sm:gap-3 h-4/5 pt-8  "
        variants={variants}
      >
        <motion.h1
          variants={variants}
          e=" pr-3 sm:mb-2 sm:mb-6 text-xl sm:text-[40px]"
        >
          Let's get in touch
        </motion.h1>

        <motion.div e="pl-3  ">
          <span e="text-xl sm:text-[30px] " variants={variants}>
            Email:
          </span>
          <span e="pl-3">Yassinejabrio.2001@gmail.com</span>
        </motion.div>
